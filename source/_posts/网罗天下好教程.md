...
此书是[《TypeScript Deep Dive》](https://github.com/basarat/typescript-book/)的中文翻译版
...
#### [写给不耐烦程序员的 Javascript](https://impatient-js.apachecn.org/#/)
...
#### [从零开始构建 JavaScript 技术栈 - 中文版](https://github.com/translation-zh/js-stack-from-scratch)

<div align='center'><img src='/images/hexo_post_346.png' alt='' width='600'/></div>
...
本仓库是 [Learn RxJS](https://github.com/btroncone/learn-rxjs) 的中文版。意在通过每个操作符的清晰示例及解释来进行 RxJS 的学习。
...
#### [尚硅谷React技术全家桶全套完整版（零基础入门到精通/男神天禹老师亲授）](https://www.bilibili.com/video/BV1wy4y1D7JT)
...
#### [建立你自己的React 翻译](https://github.com/chinanf-boy/didact-explain)

Didact的目标是, 通过提供相同API的更简单实现, 以及如何构建它的逐步说明,使React的内部更容易理解. 一旦你理解了React如何在内部工作,使用它将更容易.

#### [Why You Should Consider Reactive Programming](https://goodguydaniel.com/blog/why-reactive-programming)
