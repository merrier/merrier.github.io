...
![](https://merrier.wang/wp-content/uploads/2017/04/css-written-order-300x150.png)
...
CSS有些属性是可以缩写的，比如padding,margin,font等等，这样精简代码同时又能提高用户的阅读体验。 ![](https://merrier.wang/wp-content/uploads/2017/04/abbreviation.png)

去掉小数点前的“0”
----------

![](https://merrier.wang/wp-content/uploads/2017/04/del-zero-300x150.png)

简写命名
----

很多用户都喜欢简写类名，但前提是要让人看懂你的命名才能简写哦！ ![](https://merrier.wang/wp-content/uploads/2017/04/name.png)

16进制颜色代码缩写
----------

有些颜色代码是可以缩写的，我们就尽量缩写吧，提高用户体验为主。 ![](https://merrier.wang/wp-content/uploads/2017/04/color-abb-300x150.png)
...
这里有一篇破折号与下划线的详细讨论，英文：[点击查看](http://stackoverflow.com/questions/7560813/why-are-dashes-preferred-for-css-selectors-html-attributes) 中文篇：[点击查看](http://www.cnblogs.com/kaiye/archive/2011/06/13/3039046.html) [《CSS Secrets》](https://book.douban.com/subject/26295140/)的译者张鹏对于使用"_"还是"-"也阐述了自己的观点，比较了两者的优缺点，可以[点击这里](https://github.com/cssmagic/blog/issues/42)查看 ![](https://merrier.wang/wp-content/uploads/2017/04/underline-300x150.png)

不要随意使用Id
--------

id在JS是唯一的，不能多次使用，而使用class类选择器却可以重复使用，另外id的优先级优先与class，所以id应该按需使用，而不能滥用。 ![](https://merrier.wang/wp-content/uploads/2017/04/css-id-300x150.png)

为浏览器添加状态前缀
----------

有时候可以给选择器添加一个表示状态的前缀，让语义更明了，比如下图是添加了“.is-”前缀。 ![](https://merrier.wang/wp-content/uploads/2017/04/status-select-300x150.png)
