...
<div align='center'><img src='/images/hexo_post_98.png' alt='' width='500'/></div>
...
在译文[《CSS命名神马的真心难》](http://jiongks.name/blog/naming-css-stuff-is-really-hard/?utm_source=tuicool)中，作者指出可以根据三类情况给定一个 class 名：
...
* [推荐大家使用的CSS书写规范、顺序](http://www.cnblogs.com/AllenChou/p/5911834.html)
* [CSS命名神马的真心难](http://jiongks.name/blog/naming-css-stuff-is-really-hard/)
* [css命名方式](http://nec.netease.com/standard/css-name.html)
* [BEM——一种css命名解决方案](http://getbem.com/)
