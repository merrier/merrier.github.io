...
<div align='center'><img src='/images/hexo_post_759.png' alt='' width=''/></div>
...
<div align='center'><img src='/images/hexo_post_760.png' alt='' width=''/></div>
...
所以，Web 2.0 是一个真真正正的**寡头网络**，个别互联网公司（谷歌、苹果、Facebook、亚马逊）把我们围在了这个网络中，当点击就等于收入时，就没有人愿意说实话了，一切算法的结果是诱使点击、错误信息、假新闻、广告拦截、反广告拦截和反反广告拦截等等...

<div align='center'><img src='/images/hexo_post_761.png' alt='' width=''/></div>
...
<div align='center'><img src='/images/hexo_post_762.png' alt='' width=''/></div>
...
而 3.0 的愿景是让这场游戏的所有权和主导权回到每一个参与者手中。也就是说，最初建造这个游乐场的人只拿相对少的股权，其他的收益应该分享给游戏玩家，因为他们贡献了内容、时间、智慧，这些人才是真正能让这个平台/领域持续发展的核心动力。同时，这些人对这个平台的各种决策也应该有发言权，游戏玩家有权参与到游戏规则的制定中，因为他们对这个游戏做出了不可磨灭的贡献——这就是下面会提到的的 DAO（decentralized autonomous organization）的理念。

### 总结

|       | 1.0     | 2.0    | 3.0  |
|----------|----------|--------|-------|
| 内容与用户  | 读（read）  | 读、写（read、write） | 读、写、拥有（read、write、own）|
| 代表公司  | 新浪、搜狐、网易、hao123 | 微博、微信、抖音、谷歌、苹果、Facebook | ？？？ |
| 关键词    | 被动、缓慢、受控  | 网红、社区、垄断、中心化、贫富差距 | 自由、去中心化、隐私、低效 |
...
DeFi目前是通过跨链来解决抵押，通过[保证金制度](https://www.zhihu.com/search?q=%E4%BF%9D%E8%AF%81%E9%87%91%E5%88%B6%E5%BA%A6&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra=%7B%22sourceType%22%3A%22answer%22%2C%22sourceId%22%3A1656275835%7D)来解决杠杆，最终实现了类似于信用衍生一样的操作。
...
整个过程都是[智能合约](https://www.zhihu.com/search?q=%E6%99%BA%E8%83%BD%E5%90%88%E7%BA%A6&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra=%7B%22sourceType%22%3A%22answer%22%2C%22sourceId%22%3A1656275835%7D)（金融服务机器人）来完成的，没有人的参与。而如果我到期不还，那么我抵押的比特币就没有了。智能合约到期执行执行，把我抵押的这个比特币进行违约处理。

这样能实现了[等额抵押](https://www.zhihu.com/search?q=%E7%AD%89%E9%A2%9D%E6%8A%B5%E6%8A%BC&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra=%7B%22sourceType%22%3A%22answer%22%2C%22sourceId%22%3A1656275835%7D)，但是金融的魅力在于以小博大，所以我们需要[超额抵押](https://www.zhihu.com/search?q=%E8%B6%85%E9%A2%9D%E6%8A%B5%E6%8A%BC&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra=%7B%22sourceType%22%3A%22answer%22%2C%22sourceId%22%3A1656275835%7D)。也就是希望能够抵押1个比特币，临时的借2个，乃至于10个比特币来进行投机。你拿 1 个BTC抵押，我可以借给你10个，但是借给你之后，如果你的任何操作，导致帐户上的资产价值小于 9.05 个BTC，那么对不起，合约自动执行，你的抵押物充公。
...
<div align='center'><img src='/images/hexo_post_764.png' alt='' width=''/></div>

- NBA 球星库里就以 18 万美元的价格，购买了一副猴子的图案用作自己社交账号的头像：

<div align='center'><img src='/images/hexo_post_765.png' alt='' width=''/></div>

- 2017 年 5 月 1 日，数字视觉艺术家 Beeple 的一套作品[《Everydays：The First 5000 Days》](https://www.christies.com.cn/img/LotImages/2021/NYR/2021_NYR_20447_0001_001(beeple_everydays_the_first_5000_days034733).jpg)，以 NFT 的方式在佳士得拍出了 [6935 万美元](https://www.christies.com.cn/features/Monumental-collage-by-Beeple-is-first-purely-digital-artwork-NFT-to-come-to-auction-11510-7.aspx) 的天价。

<div align='center'><img src='/images/hexo_post_766.png' alt='' width=''/></div>
...
总结地说，DAO 是一种全新的机构形态，而且特别适合做那些能长期存续的、每个人都能从中受益的活动，比如 Wikipedia，比如体育运动等。所以这种形态可能是未来互联网上组织形态的雏形，不受任何单个人的控制却有明确的目标，能够自己进化和发展。
...
[张潇雨](https://www.douban.com/note/765107261/) 在自己的微博里说过，如果你是一个优秀的内容创造者，那么你不需要自己去了解 Web3.0，因为会有无数人来教你，告诉你怎么参与，求着你参与进来。。
...
<div align='center'><img src='/images/hexo_post_767.png' alt='' width=''/></div>

### Epic Games

经常被简称为 Epic，是一家游戏公司，它最出名的是自家《虚幻系列》游戏所引用的虚幻引擎，然后借助该引擎开发出了诸如《战争机器》、《无尽之剑》和《堡垒之夜》等游戏，将游戏的真实性提升到一个新的高度：[这才是次世代的画面！虚幻引擎5黑客帝国Demo实机演示
](https://www.ixigua.com/7040500415338644005)

（八卦一下，腾讯在 2012 年 7 月以 3.3 亿美元收购 EpicGames 已发行股本 48.4% 的股份，约占公司整体股份的四成。腾讯有权在 EpicGames 董事会提名董事，EpicGames 理论上讲可以算腾讯集团的联营公司）

### Blockstack

[Blockstack](https://www.stacks.co/) 是一款集成了分布式数据、分布式应用程序、分布式用户数据的区块链浏览器应用。

Blockstack 将数据主权交还给用户，用户数据由用户保管，未经用户许可，任何第三方无法访问用户数据。由于用户拥有了数据主权，用户可以随心所欲转移，不用再受到平台限制。

当然这样的平台或者应用还有很多，例如知名以太坊轻钱包 [MetaMask](https://metamask.io/) 就是一款浏览器插件钱包，通过插件的方式让用户在使用 PC 浏览器的时候就可以直接使用钱包，访问一些 [DApp](https://www.dapp.com/)（[去中心化应用](https://www.zhihu.com/question/265584082)），目前 MetaMask 月活跃用户已超 100 万。
...
<div align='center'><img src='/images/hexo_post_768.png' alt='' width=''/></div>
...
[OpenSea](https://opensea.io/) 是全球最大的 NFT 交易平台，目前交易热度最高的交易额已经超过了 18.8 亿美元。目前 NFT 交易大部分集中在以太坊公链，据 Dune Analytics 的数据，OpenSea 8 月以太坊交易额达到 34 亿美元，是 7 月的 10 倍多。

截至 2021-12-16，OpenSea 上七天内排名最靠前的两个项目是 [CLONE X](https://opensea.io/collection/clonex?search[sortAscending]=false&search[sortBy]=PRICE) 和 [RTFKT - CloneX Mintvial](https://opensea.io/collection/clonex-mintvial?search[sortAscending]=false&search[sortBy]=PRICE)，聪明的你可能发现了，这好像是一家公司啊？是的，它们都是 RTFKT 公司的（这家公司被 Nike 收购了，很有意思，后面是不是要发行虚拟球鞋了呢？）：
- CLONE X 就是一个个可以应用在 Metaverse 各种平台的 Avatar (虚拟化身)，粗略理解的话，你可以视 CLONE X 为各种虚拟世界里的角色皮肤，且这个皮肤的拥有者是唯一的：

<div align='center'><img src='/images/hexo_post_769.png' alt='' width=''/></div>
...
元宇宙这个概念最早出现于科幻小说《雪崩》中，这本小说首次描述并基本上创造了“元宇宙”(Metaverse)和“阿凡达”(Avatar)两个词语；在这本小说中，Metaverse 被描绘成一种数字互联网的表现形式，但它本身是基于一个虚拟的世界，类似于电影《头号玩家》和《黑客帝国》里面所描绘的那样。
...
- 腾讯：在元宇宙领域中国最有希望的公司，拥有最大的流量入口和社交平台，很早就入局游戏，有着超强的变现能力；
...
最关键的是，去中心化带来的反监管优势无疑会被洗钱所利用，那些花几千万美元买数字艺术品的人很难理解为是真的“懂艺术”，元宇宙可以用来短期投机，但长期投资的话还需观察。
...
- [Web3 — Solving trust issues using math](https://www.gillesdc.com/blog/web3)
- [Messari年度报告-Crypto Theses for 2022(中文翻译版)首发！ - W3.Hitchhiker](https://mirror.xyz/0xE43a21Ee76b591fe6E479da8a8a388FCfea6F77F/znaPSL__AdRETrJoWmr-uxSkNeWJ3HQAkCJrfxmzfnA)
- [今晚围观了张潇雨关于 Web 3.0 的直播，一些有启发的问答与观点](https://web.okjike.com/originalPost/6197b9bc248f4b00105a0ca9)
- [Web3.0跟普通人究竟有什么关系：世界属于热爱玩耍的人——写在看张潇雨直播后](https://mp.weixin.qq.com/s/rKSOz83BosRFKsYzDNaM6Q)
- [元宇宙与Web3.0的关系](https://coindollarpay.com/what-role-does-web3-0-play-in-metaverse/)
- [以太坊创始人加文·伍德：我们为什么需要 Web 3.0 ？](https://www.bigfang.vip/web3/)
- [一张CryptoPunks价值 4200枚ETH（一千万美金）](https://www.bigfang.vip/cryptopunks/)
- [未来世界—元宇宙Metaverse](https://www.bigfang.vip/%e5%85%83%e5%ae%87%e5%ae%99metaverse/)
...
- [web3.0 指的是什么？未来将有怎样的发展？](https://www.zhihu.com/question/341559382)
- [最近很火的DeFi，到底是什么？](https://www.zhihu.com/question/324838085)
- [NFT、元宇宙，突然火起来的板块到底是什么？](http://www.cfdfe.cn/content/1117)
- [39 NFT ideas & examples: The wild, the weird & the wonderful](https://queue-it.com/blog/nft-ideas-for-inspiration/)
- [DAO是什么意思，什么的缩写？](https://www.zhihu.com/question/31382068)
- [分布式自治组织（The DAO）：一个“海星”似的区块链组织](http://www.woshipm.com/blockchain/952552.html)
- [波卡是什么？一篇人人都看得懂的Polkadot科普文](https://www.okex.com/academy/zh/what-is-polkadot-a-polkadot-popular-science-article-that-everyone-can-understand/)
- [一块虚拟土地2700万，炒房团杀入元宇宙！歌手林俊杰也出手，12万美元买元宇宙虚拟房产...](https://news.stcn.com/sd/202112/t20211203_3932287.html)