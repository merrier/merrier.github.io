...
[Web 内容无障碍指南（WCAG）2.1](https://www.w3.org/Translations/WCAG21-zh/)涵盖了使 Web 内容更易于访问的各种建议。遵循这些准则将使更多残疾人更容易获取网站内容，其中包括失明和弱视、耳聋和听力丧失、运动受限、言语障碍、光敏性和多种残疾组合的残疾人，以及有学习障碍和认知局限的残疾人; 但不会满足这些残疾用户的所有需求。这些准则旨在解决台式机，笔记本电脑，平板电脑和移动设备上的 Web 内容的无障碍问题。遵循这些准则通常也会使网站内容对用户更有用。
...
关于图片加载失败优化这部分来自于张鑫旭的文章：[图片加载失败后 CSS 样式处理最佳实践](https://www.zhangxinxu.com/wordpress/2020/10/css-style-image-load-fail/)，具体讲解欢迎看原文。
...
> [小 tip:CSS vw 让 overflow:auto 页面滚动条出现时不跳动](https://www.zhangxinxu.com/wordpress/2015/01/css-page-scrollbar-toggle-center-no-jumping/)
...
> [小 tip-一种图片加载状态效果的实现](https://juejin.cn/post/6844903704357765134)
...
AMP 全称 Accelerated Mobile Pages，顾名思义是为了加速移动网络的网页加载从而提升体验。[AMP 官网](https://amp.dev/zh_cn/) 上称其可在很多平台上提供卓越的用户体验。AMP 网页采用 3 大核心组件构建而成：
...
4. 对于张数为 n 的图片，我们都可以分解成 n=2∗x+1∗yn = 2 _ x + 1 _ yn=2∗x+1∗y 的形式，其中 x 、 y 指代张数为 2 和 1 的图片分组排列；
...
6. 对于张数为 n 的图片，我们都可以分解成 n=3∗x+2∗y+1∗zn = 3 _ x + 2 _ y + 1 \* zn=3∗x+2∗y+1∗z 的形式，其中 x 、 y 、z 指代张数为 3 、2 和 1 的图片分组排列；
...
<div align='center'><img src='/images/hexo_post_807.png' alt='' /></div>

<div align='center'><img src='/images/hexo_post_808.png' alt='' /></div>
...
-   [如何将 Web 主页性能提升十倍以上？](https://mp.weixin.qq.com/s/6bwlUZoCN4ZuT_tt263gPQ)
...
-   [Web 性能优化：Preload,Prefetch 的使用及在 Chrome 中的优先级](https://segmentfault.com/a/1190000018828048)
...
-   [UI 工程的要素](https://overreacted.io/zh-hans/the-elements-of-ui-engineering/)
...
-   [多语言 UI 设计避坑指南](https://mp.weixin.qq.com/s/_XUNdR0_TXcv68JKysNnIw)
-   [你真的认为 Google 翻译不影响前端页面功能吗?](https://mp.weixin.qq.com/s?__biz=MzkxMjI3MTA1Mg==&mid=2247514469&idx=1&sn=0b6e8ffb521e08bb485bdd3aa4e25f93&chksm=c10d8ac6f67a03d0f07d58753f3f98f75579fd4232f8e3a813072420d2835bbb3670893af17b&scene=21#wechat_redirect)
...
-   [【第 2147 期】交互导入模式](https://mp.weixin.qq.com/s/6O3CYnzbBCHrUWeYG-Yx4Q)
