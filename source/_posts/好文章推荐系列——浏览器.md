---
title: 好文章推荐系列——浏览器
urlname: browser-good-articles
id: 6149582958493859
categories:
  - 推荐
tags:
  - 浏览器
img: /images/hexo_thumbnail_152.jpg
date: 2017-08-07 16:29:36
---

### [googlebooks-chrome](https://www.google.com/googlebooks/chrome/big_00.html)

讲浏览器的漫画，来自 Google 官方团队，生动有趣

### [SEO大神Neil Patel六大成功秘籍](https://zhuanlan.zhihu.com/p/46361130)
...
### [一文彻底搞懂Cookie、Session、Token到底是什么](https://juejin.cn/post/6844904009061367821)

详细的介绍了 Cookie、Session、Token 的设计理念以及相同点和不同点

### [HTTP API Design Guide](https://geemus.gitbooks.io/http-api-design/content/en/)

This guide describes a set of HTTP+JSON API design practices, originally extracted from work on the [Heroku Platform API](https://devcenter.heroku.com/articles/platform-api-reference).
...
### [Chrome架构：仅仅打开了1个页面，为什么有4个进程](https://blog.poetries.top/browser-working-principle/guide/part1/lesson01.html)

Chrome 只是打开了 1 个页面，为什么要启动这么多进程呢？

### [Guidelines for URL Display](https://chromium.googlesource.com/chromium/src/+/refs/heads/main/docs/security/url_display_guidelines/url_display_guidelines.md)
...
### [XSS_Cheat_Sheet_2020_Edition](https://github.com/heroanswer/XSS_Cheat_Sheet_2020_Edition)
...
### [逐帧分析youtube](https://zhuanlan.zhihu.com/p/69292215)
...
### [浏览器是如何调度进程和线程的？](https://cloud.tencent.com/developer/article/1721038)
